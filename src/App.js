...
const DexoFluxWebsite = () => {
  ...
  const handleEmailClick = () => {
    window.location.href =
      "mailto:Dexoflux@gmail.com?subject=Inquiry%20about%20DexoFlux%20Courses&body=Hello%20DexoFlux%20Team,%0A%0AI%20am%20interested%20in%20learning%20more%20about%20your%20courses.%0A%0APlease%20send%20me%20more%20information.%0A%0ARegards,%0A[Your%20Name]";
  };
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = "+91 8801659042";
    const message =
  ...
  const courses = [
    ...
    { name: "Web Development", icon: "🌐", desc: "React JS, Next JS" },
    { name: "Desktop Application", icon: "💻", desc: "Electron JS" },
    { name: "Backend Development", icon: "🔧", desc: "NodeJS, ExpressJS" },
    { name: "Android Development", icon: "📱", desc: "Native Android apps" },
    { name: "iOS Development", icon: "🍎", desc: "Native iOS applications" },
    {
      name: "Cross-Platform Mobile",
      icon: "🔄",
      desc: "Flutter, React Native, .NET MAUI",
    },
  ...
  const learningPath = [
    {
      ...
      desc: "Master core concepts with expert guidance",
      icon: "📚",
    },
    {
      step: 2,
      title: "Hands-On Projects",
      desc: "Work on real-world industry projects",
      icon: "💻",
    },
    {
      step: 3,
      title: "Career Preparation",
      desc: "Resume building and interview training",
      icon: "🎯",
    },
    {
      step: 4,
      title: "Job Placement",
      desc: "Get placed with our hiring partners",
      icon: "🚀",
    },
  ];
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Transform your passion into profession with industry-leading
            training, real-world projects, and guaranteed placement assistance
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <a
              href="#courses"
              className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-indigo-500/50 transition transform hover:scale-105"
            >
              Explore Courses
            </a>
            <a
              href="#contact"
              className="px-8 py-4 bg-slate-800 border border-indigo-500/30 rounded-lg font-semibold hover:bg-slate-700 transition"
            >
              Get Started
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {courses.map((course, idx) => (
            ...
            >
              ...
              <h4 className="text-white font-bold mb-2 text-indigo-300">
                {course.name}
              </h4>
              <p className="text-gray-200 text-sm">{course.desc}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, idx) => (
            ...
            >
              ...
              <div className="text-white md:text-4xl font-bold text-indigo-300 mb-2">
                {stat.number}
              </div>
          ...
          {learningPath.map((path, idx) => (
            ...
            >
              <div className="p-6 bg-slate-900/50 backdrop-blur-sm border border-indigo-500/20 rounded-xl hover:border-indigo-500/50 transition">
                ...
                <p className="text-gray-200 text-sm">{path.desc}</p>
              </div>
      ...
      >
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/30 rounded-2xl">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h4 className="text-2xl font-bold mb-3 text-indigo-300">
                Special Support for Freshers
              </h4>
              <p className="text-gray-100 text-lg">
                We guide students step-by-step to achieve their first IT job
                with confidence — from skills training to interview success. Our
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-xl sm:text-2xl font-semibold text-indigo-300 mb-3">
                  +91 8801659042
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-lg sm:text-xl font-semibold text-indigo-300 mb-3 break-words">
                  Dexoflux@gmail.com
                </p>
                <p className="text-gray-300 text-sm mb-4">
                  Click to send email
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-xl sm:text-2xl font-semibold text-green-300 mb-3">
                  +91 8801659042
                </p>
                <p className="text-gray-300 text-sm mb-4">
          ...
          <div className="relative p-6 sm:p-8 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 border border-indigo-500/30 rounded-xl sm:rounded-2xl overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-center text-lg font-semibold text-indigo-300">
